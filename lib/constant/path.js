...
const DEFAULT_CONFIG_PATH_WITH_FILE = path.resolve(__dirname, '../../config/config-file.yml');
const DEFAULT_CONFIG_PATH_WITH_DIR = path.resolve(__dirname, '../../config/config-dir.yml');
