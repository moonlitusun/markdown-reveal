...
const DEFAULT_CONFIG_PATH_WITH_FILE = path.resolve(DEFAULT_TPL_PATH, './config.file.yml');
const DEFAULT_CONFIG_PATH_WITH_DIR = path.resolve(DEFAULT_TPL_PATH, './config.dir.yml');
